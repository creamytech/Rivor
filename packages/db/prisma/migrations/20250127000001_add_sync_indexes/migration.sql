...
CREATE INDEX IF NOT EXISTS "EmailThread_emailAccountId_updatedAt_idx" 
...
CREATE INDEX IF NOT EXISTS "EmailAccount_syncStatus_lastSyncedAt_idx" 
ON "EmailAccount"("syncStatus", "lastSyncedAt" DESC);

-- Index for secure token management queries
CREATE INDEX IF NOT EXISTS "SecureToken_orgId_provider_tokenType_idx" 
