...
export default function SignInPage() {
  ...
  const getSubMessage = () => {
    if (expired || reauth)
      return "Secure authentication via Google or Microsoft";
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" role="main">
      ...
      <div
        className="absolute top-20 left-20 w-64 h-64 bg-white/5 rounded-full animate-float"
        aria-hidden="true"
      />
      <div
        className="absolute bottom-32 right-32 w-32 h-32 bg-white/5 rounded-full animate-float-delay"
        aria-hidden="true"
      />
      <div
        className="absolute top-1/2 right-1/4 w-20 h-20 bg-white/5 rounded-full animate-pulse"
        aria-hidden="true"
      />
      ...
      >
        <div className="card p-8 space-y-6 animate-fade-up">
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  >
                    {error === "OAuthCallback"
                      ? "We couldn't complete sign-in. Try again or use a different provider."
                      : error === "AccessDenied"
                        ? "Access was denied. Please check your permissions and try again."
                        : error === "Configuration"
                          ? "Provider unavailable. Please try again later."
                          : error === "Verification"
            ...
            {!loading && providers && Object.keys(providers).length === 0 && (
              <div className="card-subtle text-center p-6 animate-fade-up-delay-2">
                ...
                <p className="text-sm text-muted-foreground">
                  No authentication providers are configured. Please contact
                  your administrator to set up OAuth credentials.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="text-center animate-fade-up-delay-4">
            <p className="text-sm text-muted-foreground">
              ...
              <a
                href="/auth/signin"
                className="link-arrow text-rivor-teal hover:text-rivor-aqua transition-colors"
              >
        ...
        <footer
          className="mt-8 text-center animate-fade-up-delay-5"
          role="contentinfo"
        >
          <div className="flex items-center justify-center space-x-6 text-xs text-muted-foreground">
            <div
              ...
              role="img"
              aria-label="SOC 2 compliance ready"
            >
            ...
            <div
              className="flex items-center space-x-2"
              role="img"
              aria-label="OAuth 2.0 authentication"
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 24 24"
            ...
            <a
              href="/security"
              className="flex items-center space-x-2 hover:text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-rivor-teal rounded-md px-2 py-1"
            >
